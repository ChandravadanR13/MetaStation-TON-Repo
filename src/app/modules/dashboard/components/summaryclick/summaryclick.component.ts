...
@Component({
  selector: 'app-summaryclick',
  templateUrl: './summaryclick.component.html',
  styleUrls: ['./summaryclick.component.scss']
})
export class SummaryclickComponent {
  basicOptions: any;
  lineStylesData: any;
  chart: any;
  id : number = 1;
