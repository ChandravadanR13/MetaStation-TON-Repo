...
@Component({
  selector: 'app-main-tradingl',
  templateUrl: './main-tradingl.component.html',
  styleUrls: ['./main-tradingl.component.scss']
})
export class MainTradinglComponent {
  totalRecords = 10;
  first = 0;
  last = 10;
  summury: any = [];
  ...
  // add(){
  //   this.router.navigate(['/marketplace/copy-trading']);
  // }
  onClickCreate() {
