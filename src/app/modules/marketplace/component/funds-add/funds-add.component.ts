...
@Component({
  selector: 'app-funds-add',
  templateUrl: './funds-add.component.html',
  styleUrls: ['./funds-add.component.scss']
})

export class FundsAddComponent {
  commonOptions: any[] = [];
  date: any | undefined;
  basicOptions: any;
  lineStylesData: any;
  ...
  backToPrevious(){
    this.router.navigate(['/app/marketplace/fundmain']);
  }
  ngOnInit() {
